...
## О программе
Реализация библиотеки string.h с дополнениями (с собственной реализацией функций sprintf и sscanf). 
Библиотека string.h является основной библиотекой языка Си по обработке строк.
...
Необходимо реализовать описанные функции библиотеки string.h: 
...
## Дополнительные требования. Частичная реализация функции sprintf
...
## Дополнительные требования. Реализация некоторых модификаторов формата функции sprintf
...
## Дополнительные требования. Реализация функции sscanf
...
## Дополнительные требования. Реализация специальных функций обработки строк
...
- На реализацию функций накладываются все изложенные требования, исключая требование о сравнении вашей реализации со стандартом.
