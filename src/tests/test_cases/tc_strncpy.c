...
START_TEST(simple_case_1) {
  ...
  char *s21_str2 = "54hgd";
  char *s21_ch = s21_strncpy(s21_str1, s21_str2, s21_strlen(s21_str2));
  char str1[SIZE] = "1234567890";
  char *str2 = "54hgd";
  char *ch = strncpy(str1, str2, s21_strlen(str2));
...
START_TEST(simple_case_2) {
  char s21_str1[SIZE] = "1234567890";
  char *s21_str2 = "54hgd";
  char *s21_ch = s21_strncpy(s21_str1, s21_str2, s21_strlen(s21_str1));
  char str1[SIZE] = "1234567890";
  char *str2 = "54hgd";
  char *ch = strncpy(str1, str2, s21_strlen(str1));
  s21_size_t s21_len = s21_strlen(s21_ch);
  s21_size_t len = s21_strlen(ch);
  s21_size_t t_len = len > s21_len ? len : s21_len;
  ck_assert_int_eq(s21_memcmp(s21_ch, ch, t_len), 0);
...
START_TEST(simple_case_3) {
  char s21_str1[SIZE] = "1234567890";
  char *s21_str2 = "54hgd";
  char *s21_ch = s21_strncpy(s21_str1, s21_str2, 1);
  char str1[SIZE] = "1234567890";
  char *str2 = "54hgd";
  char *ch = strncpy(str1, str2, 1);
  s21_size_t s21_len = s21_strlen(s21_ch);
  s21_size_t len = s21_strlen(ch);
  s21_size_t t_len = len > s21_len ? len : s21_len;
  ck_assert_int_eq(s21_memcmp(s21_ch, ch, t_len), 0);
...
START_TEST(simple_case_5) {
  ...
  char *s21_ch = s21_strncpy(s21_str2, s21_str1, s21_strlen(s21_str2));
  char *str1 = "1dgsg890";
  char str2[SIZE] = "54hgd";
  char *ch = strncpy(str2, str1, s21_strlen(str2));
  s21_size_t s21_len = s21_strlen(s21_ch);
  s21_size_t len = s21_strlen(ch);
  s21_size_t t_len = len > s21_len ? len : s21_len;
  ck_assert_int_eq(s21_memcmp(s21_ch, ch, t_len), 0);
...
START_TEST(simple_case_11) {
  char s21_str1[SIZE] = {'\0'};
  char *s21_str2 = "It is new string!";
  char *s21_ch = s21_strncpy(s21_str1, s21_str2, 2);
  char str1[SIZE] = {'\0'};
  char *str2 = "It is new string!";
  char *ch = strncpy(str1, str2, 2);
  s21_size_t s21_len = s21_strlen(s21_ch);
  s21_size_t len = s21_strlen(ch);
  s21_size_t t_len = len > s21_len ? len : s21_len;
  ck_assert_int_eq(s21_memcmp(s21_ch, ch, t_len), 0);
